  ...
  return (
    <div className="bg-slate-400 py-20 px-10 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-3xl  shadow-xl">
        ...
        <button
          className="block mt-5 bg-blue-500 text-white p-2 text-center
         rounded-xl w-2/4 mx-auto hover:bg-teal-500 hover:text-black
      ...
      <div className="bg-white p-6 rounded-3xl  shadow-xl ">
        <div className="flex mb-5 justify-between items-center">
          ...
          <div className="space-x-3">
            <span>⭐️ 4.9</span>
            <span className="shadow-lg p-2 rounded-t-md">♥</span>
          </div>
        </div>
        ...
        <div className="flex flex-col ">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5 ">
              <button className="p-1.5 rounded-lg space-x-10 bg-blue-200 flex justify-center items-center aspect-square w-8 font-medium text-xl text-gray-500">
                -
              </button>
              <span>1</span>
              <button className="p-1.5 rounded-lg  space-x-10 bg-blue-200 flex justify-center items-center aspect-square w-8 font-medium text-xl text-gray-500">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="bg-blue-500 py-2 px-5 text-sm text-white rounded-lg">
              Add to cart
            </button>
          </div>
        </div>
