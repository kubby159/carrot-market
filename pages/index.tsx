...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-400 xl:place-content-center py-20 px-20 grid gap-10 xl:grid-cols-3 min-h-screen">
      <div className="bg-white  xl:flex flex-col justify-around p-6 rounded-3xl shadow-xl">
