...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-400 dark xl:place-content-center py-20 px-20 grid gap-10 xl:grid-cols-3 min-h-screen">
      <div className="bg-white dark:bg-black  xl:flex flex-col justify-around p-6 rounded-3xl shadow-xl">
        ...
        <button
          className="mt-5 bg-blue-500 text-white p-3 dark:bg-black dark:border-white dark:border-2 dark:hover:bg-black dark:hover:bg-white dark:hover:text-black
